...
if __name__=='__main__':
	...
	flat_PG = Reshape((N*glove_emb,)) (inputPG)
	flat_QG = Reshape((N*glove_emb,))  (inputQG)
	
	# print flat_PG.shape,flat_QG.shape



	final_P = Concatenate()([P_rep,flat_PG])
	final_Q = Concatenate()([Q_rep,flat_QG])
